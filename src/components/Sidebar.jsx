    ...
    return (
        <>
            ...
            <aside
                ...
                className={`fixed md:sticky top-0 left-0 z-[110] h-screen bg-[var(--sidebar-bg)] border-r border-green-200/50 flex flex-col transition-all duration-300 ease-in-out shadow-[10px_0_40px_-15px_rgba(0,0,0,0.05)]
